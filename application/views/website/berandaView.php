    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
          <img class="img-fluid" src="<?=assets('images/header.png')?>" alt="">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?=templates('img/home/service1.png','website')?>" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?=templates('img/home/service2.png','website')?>" alt="">
            </div>
            <div class="service-card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?=templates('img/home/service3.png','website')?>" alt="">
            </div>
            <div class="service-card-body">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
          <div class="about-img">
            <img class="img-fluid" src="<?=templates('img/home/about-img.png','website')?>" alt="">
          </div>
        </div>
  ...
  <section class="section-margin pb-xl-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?=templates('img/home/tour1.png','website')?>" alt="">
        ...
        <div class="col-md-6">
          ...
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?=templates('img/home/tour2.png','website')?>" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-7">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?=templates('img/home/tour3.png','website')?>" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
        ...
        <div class="col-md-6 col-lg-5">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?=templates('img/home/tour4.png','website')?>" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
          ...
          <div class="row">
            <div class="col-md-3 col-lg-2 align-self-center">
              <div class="testimonial__img">
                <img class="card-img rounded-0" src="<?=templates('img/testimonial/t-slider1.png','website')?>" alt="">
              </div>
            </div>
  ...
  <section class="section-padding bg-gray">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="<?=templates('img/blog/blog-1.png','website')?>" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="<?=templates('img/blog/blog-2.png','website')?>" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="<?=templates('img/blog/blog-3.png','website')?>" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
